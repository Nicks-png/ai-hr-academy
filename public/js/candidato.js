...
async function loadBackupConfig() {
  // Mesmo retry com backoff do loadVagas() — sem isso, uma falha única bem na hora
  // em que o Render está acordando deixa backupCfg travado em null pro resto da
  // sessão, e a candidatura inteira segue sem a cópia de garantia (achado em produção).
