...
router.get('/api/vagas-abertas', (_req, res) => {
  // Candidatos avançados da triagem (com ai_score ou contactados)
  ...
  // Triagens recentes (últimos 60 dias) para vagas sem candidatos avançados ainda
  ...
  // Adicionar vagas de triagens recentes que ainda não têm candidatos avançados
